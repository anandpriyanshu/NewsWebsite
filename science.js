...
const fetchData = async () => {
  const response = await fetch(
    "https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=158ef0a3c9194a348d65759ee0820c43&pageSize=10&page=1"
  );
...
window.addEventListener("scroll", () => {
  ...
  if (
    ...
    setTimeout(() => {
      fetch(
        `https://newsapi.org/v2/top-headlines?country=us&category=science&apiKey=158ef0a3c9194a348d65759ee0820c43&pageSize=10&page=${page}`
      )
        .then((res) => res.json())
        .then((json) => {
          json.articles.map((ele) => {
